            ...
            <div class="card-header pb-0 px-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-end">
                        <a class="btn btn-sm btn-round bg-gradient-default mb-0 me-2" href="<?= site_url('siswa/import') ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Import Data Siswa Dari Format Excel" data-container="body" data-animation="true"><i class="fas fa-upload me-3" aria-hidden="true"></i>Siswa</a>
                        <button class="btn btn-sm btn-round bg-gradient-dark mb-0" type="button" data-bs-toggle="modal" data-bs-target="#addSiswa" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambah Siswa" data-container="body" data-animation="true"><i class="fas fa-plus me-3" aria-hidden="true"></i>Siswa</button>
                    </div>
                </div>
            </div>
            <div class="card-body pt-4 p-3">
                <div class="form-group mb-3">
                    <div class="input-group">
                        ...
                        <input class="form-control" placeholder="Cari Siswa ..." id="myInput" type="text">
                    </div>
                </div>
                <ul class="list-group">
                    <?php 
